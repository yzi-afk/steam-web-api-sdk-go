...
type GetTeamInfoByTeamIDResponse struct {
	Result struct {
		...
		Teams  []DOTA2TeamInfo `json:"teams"`
	} `json:"result"`
}

type DOTA2TeamInfo struct {
	Name             string `json:"name"`
	Tag              string `json:"tag"`
	...
	Player0AccountID uint64 `json:"player_0_account_id,omitempty"`
	Player1AccountID uint64 `json:"player_1_account_id,omitempty"`
	Player2AccountID uint64 `json:"player_2_account_id,omitempty"`
	AdminAccountID   uint64 `json:"admin_account_id"`
	Player3AccountID uint64 `json:"player_3_account_id,omitempty"`
	Player4AccountID uint64 `json:"player_4_account_id,omitempty"`
	Player5AccountID uint64 `json:"player_5_account_id,omitempty"`
	Player6AccountID uint64 `json:"player_6_account_id,omitempty"`
}
...
type GetLiveLeagueGamesResponse struct {
	Result struct {
		Games  []DOTA2LiveMatchDetail `json:"games"`
		Status int                    `json:"status"`
	} `json:"result"`
}

type DOTA2LiveMatchDetail struct {
	Players []struct {
...
type GetDOTA2MatchHistoryResponse struct {
	Result struct {
		...
		Matches          []DOTA2MatchHistoryDetail `json:"matches"`
	} `json:"result"`
}

type DOTA2MatchHistoryDetail struct {
	MatchID       uint64                          `json:"match_id"`
	...
	Players       []DOTA2PlayerMatchHistoryDetail `json:"players"`
}

type DOTA2PlayerMatchHistoryDetail struct {
...
type GetDOTA2MatchDetailsResponse struct {
	Result DOTA2MatchDetail `json:"result"`
}

type DOTA2MatchDetail struct {
	RadiantWin            bool                      `json:"radiant_win"`
	Duration              int                       `json:"duration"`
	PreGameDuration       int                       `json:"pre_game_duration"`
	StartTime             int                       `json:"start_time"`
	...
	PicksBans             []DOTA2MatchDetailPickBan `json:"picks_bans"`
	Players               []DOTA2PlayerMatchDetail  `json:"players"`
}

type DOTA2MatchDetailPickBan struct {
...
type DOTA2PlayerMatchDetail struct {
	AccountID         uint64 `json:"account_id"`
	PlayerSlot        int    `json:"player_slot"`
	HeroID            int    `json:"hero_id"`
	Item0             int    `json:"item_0"`
